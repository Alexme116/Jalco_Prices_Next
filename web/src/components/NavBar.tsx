...
export default function NavBar() {
    ...
    return (
        <section className="relative flex items-center justify-between h-20 p-5 max-md:px-3 max-md:h-16 bg-white">
            {/* Left Side */}
            <div className="flex items-center gap-10">
                ...
                >
                    <Image
                        src={JalcoLogo}
                        alt="Jalco"
                        className="h-14 w-auto max-md:h-10 max-md:w-auto rounded-lg"
                    />
                </button>

                <div
                    className={`flex items-center gap-10 transition-all duration-500 overflow-hidden
                            ${isDevice == "Mobile" ? "hidden" : ""}
                            ${user == null ? "w-0" : user.rol == "admin" ? "w-[290px]" : "w-[92px]"
                        }`}
                >
                    {/* Dashboard Icon */}
                    {isDevice != "Mobile" && (
            ...
            {showSettings && 
                <div
                    className="z-20 left-0 top-0 absolute h-svh w-svw"
